...
export default function Evidence() {
  ...
  return (
    <div className="bg-[#090a0c] content-stretch flex flex-col items-start relative size-full" data-name="peril-pricing-evidence">
      ...
      <div className="content-stretch flex flex-col gap-[20px] items-start pb-[40px] pt-[64px] px-[120px] relative shrink-0 w-full" data-name="evidence-hero">
        ...
        <h1 className="font-serif font-extrabold leading-[normal] not-italic relative shrink-0 text-[42px] text-white m-0">Evidence-Driven Parametric Pricing</h1>
      ...
      <div className="content-stretch flex flex-col gap-[24px] items-start pb-[64px] px-[120px] relative shrink-0 w-full" data-name="matrix-container">
        <div className="content-stretch flex items-center justify-between relative shrink-0 w-full gap-[16px]">
          <div className="content-stretch flex flex-col gap-[6px] items-start leading-[normal] relative shrink-0">
            ...
            <p className="font-serif font-extrabold not-italic relative shrink-0 text-[24px] text-white m-0">{`Active Rate Table & Multipliers`}</p>
          </div>
          <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
            <div className="content-stretch flex gap-[6px] items-center">
              <div className="bg-[#14171f] border border-[#1e222a] border-solid rounded-[2px] size-[12px]" />
              <p className="font-serif text-[#9ca3af] text-[12px] whitespace-nowrap m-0">Sold at this multiple (live)</p>
            </div>
            <div className="content-stretch flex gap-[6px] items-center">
              <div className="bg-[#1c1f26] border border-[#ff3b30] border-solid rounded-[2px] size-[12px]" />
              <p className="font-serif text-[#9ca3af] text-[12px] whitespace-nowrap m-0">Not sold: would pay too often</p>
            </div>
          </div>
        </div>
        ...
        <div className="peril-glass border border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[12px] shrink-0 w-full" data-name="matrix-table-box">
          ...
          {live?.map((c) => (
            <div key={c.cover} className="border-[#1e222a] border-b border-solid content-stretch flex items-center p-[16px] relative shrink-0 w-full">
              <div className="content-stretch flex flex-col gap-[4px] items-start leading-[normal] relative shrink-0 w-[220px]">
                <p className="font-serif font-bold not-italic text-[14px] text-white m-0">{serviceName(c.cover)}</p>
                <p className="font-mono font-normal text-[#9ca3af] text-[11px] m-0">{c.host}</p>
              </div>
              <p className="font-mono font-normal leading-[normal] relative shrink-0 text-[13px] text-center text-white w-[120px] m-0">{SERIOUS_OUTAGES_12M[c.cover] ?? "?"}</p>
              {TIERS.map((t) => {
                ...
                return (
                  <div key={t} className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-center min-w-px relative">
                    {m !== undefined ? (
                      <div className="bg-[#14171f] border border-[#1e222a] border-solid flex justify-center px-[12px] py-[6px] rounded-[6px] w-[64px]">
                        <p className="font-mono font-bold text-[12px] text-white m-0">{m}x</p>
                      </div>
                    ) : (
                      <div className="bg-[rgba(255,59,48,0.12)] border border-[#ff3b30] border-solid flex px-[8px] py-[4px] rounded-[4px]">
                        <p className="font-mono font-normal text-[#ff3b30] text-[10px] m-0">NOT SOLD</p>
                      </div>
                    )}
                    {seen !== undefined && <p className="font-mono text-[#4b5563] text-[10px] m-0">{seen} ≥{hours(t)}</p>}
                  </div>
                );
              })}
            </div>
        ...
        <p className="font-serif text-[#4b5563] text-[12px] m-0">
      ...
      <div className="content-stretch flex flex-col gap-[32px] items-start pb-[64px] px-[120px] relative shrink-0 w-full" data-name="methodology-container">
        <div className="content-stretch flex flex-col gap-[6px] items-start leading-[normal] relative shrink-0">
          ...
          <p className="font-serif font-extrabold not-italic text-[24px] text-white m-0">Active Risk Calculation Methodology</p>
        </div>
        ...
        <div className="bg-[#14171f] border border-[#1e222a] border-solid content-stretch flex gap-[32px] items-center p-[32px] relative rounded-[12px] shrink-0 w-full" data-name="formula-block">
          <div className="content-stretch flex flex-[1_0_0] flex-col gap-[14px] items-start min-w-px relative">
            <p className="font-mono font-normal text-[#9ca3af] text-[11px] m-0">HOW A MULTIPLE IS SET (THE PREMIUM IS YOURS TO CHOOSE)</p>
            <p className="font-mono text-white text-[15px] m-0">
          ...
          <div className="content-stretch flex flex-col font-normal gap-[8px] items-start relative shrink-0 w-[440px]">
            <p className="font-mono text-[#9ca3af] text-[11px] m-0">WORKED EXAMPLE (GITHUB 4H)</p>
            <p className="font-serif leading-[18px] not-italic text-[#9ca3af] text-[13px] m-0">
      ...
      <div className="content-stretch flex flex-col items-start pb-[64px] px-[120px] relative shrink-0 w-full" data-name="omission-callout">
        <div className="bg-[rgba(255,59,48,0.12)] border border-[#ff3b30] border-solid content-stretch flex flex-col gap-[12px] items-start p-[24px] relative rounded-[12px] shrink-0 w-full">
          <div className="content-stretch flex gap-[8px] items-center leading-[normal] text-[#ff3b30] whitespace-nowrap">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#ff3b30" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          <p className="font-serif font-normal leading-[20px] not-italic text-[13px] text-white m-0">
        ...
        <div className="peril-glass border border-solid content-stretch flex flex-col gap-[20px] items-start p-[32px] relative rounded-[12px] shrink-0 w-full">
          ...
          <div className="content-stretch flex gap-[32px] items-start relative shrink-0 w-full">
            <div className="content-stretch flex flex-[1_0_0] flex-col gap-[12px] items-start min-w-px">
              {[
                ["DATA FILE", <a key="f" href={`${REPO}/blob/main/${SNAPSHOT.file}`} target="_blank" rel="noreferrer" className="font-mono text-white underline">{SNAPSHOT.file}</a>],
                ["GENERATED", <span key="g" className="font-mono text-white">{SNAPSHOT.generated} (commit {SNAPSHOT.commit})</span>],
                ...
                <div key={i} className="w-full flex flex-col gap-[12px]">
                  {i > 0 && <div className="bg-[#1e222a] h-px w-full" />}
                  <div className="flex items-start justify-between text-[12px] w-full gap-[16px]">
                    <p className="font-serif text-[#9ca3af] m-0">{k}</p>
                    {v}
                  </div>
                </div>
              ))}
            ...
            <div className="content-stretch flex flex-[1_0_0] flex-col gap-[12px] items-start min-w-px">
              {[
                ["SCRIPT", <a key="s" href={`${REPO}/blob/main/deploy/price_table.py`} target="_blank" rel="noreferrer" className="font-mono text-white underline">deploy/price_table.py</a>],
                ["PRICES ON CHAIN", <a key="c" href={addressUrl(PERIL)} target="_blank" rel="noreferrer" className="font-mono text-white underline">covered() on {PERIL.slice(0, 8)}…</a>],
                ["REPRODUCIBILITY", <span key="r" className="font-serif text-[#9ca3af] text-[11px] text-right max-w-[340px]">Rerun the script to rebuild the table. Incidents after the snapshot can shift the counts.</span>],
              ].map(([k, v], i) => (
                <div key={i} className="w-full flex flex-col gap-[12px]">
                  {i > 0 && <div className="bg-[#1e222a] h-px w-full" />}
                  <div className="flex items-start justify-between text-[12px] w-full gap-[16px]">
                    <p className="font-serif text-[#9ca3af] m-0 whitespace-nowrap">{k}</p>
                    {v}
                  </div>
                </div>
              ))}
